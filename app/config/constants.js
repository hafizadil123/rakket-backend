...
const defaultConfig = {
  ...
  mongo: {
    seed: true,
    uri: 'mongodb+srv://adilsikandar:adil1234@cluster0.c77nh.mongodb.net/reddish',
    options: {
      db: {
        safe: true,
      },
   ...
   */
  security: {
    sessionSecret: process.env.SESSION_SECRET || 'i-am-the-secret-key-of-rakket-project',
...
const environmentConfigs = {
  development: {
    mongo: {
      uri: process.env.MONGO_URI || 'mongodb+srv://adilsikandar:adil1234@cluster0.c77nh.mongodb.net/reddish',
    },
    security: {
      saltRounds: 4,
    },
